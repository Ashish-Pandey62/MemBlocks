...
class LocomoRunner(BaseRunner):
    ...
    async def _create_session(self, user_id: str, block_name: str):
        ...
        """
        client = MemBlocksClient(MemBlocksConfig(memory_window_limit=30,keep_last_n=0,llm_provider_name="ollama", llm_model=self.config.model))
